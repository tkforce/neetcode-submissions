class Solution {
     ...
     */
    exist(board, word) {
        // find the first charater of the word in the board -> there could be multiple start
        // make a decision tree that can either go any directions (except for the previous and boundary)
        // stop when boundary reached or all words are found
        ...
        if(startPositions.length == 0) return false;
            ...
            board[r][c] = '#';
            // 2. 鑽下去：遞迴的去找四個方向，當有任一個方向最終回傳true就代表找到
